...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.5097}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0593}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0525}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0604}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0536}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0593}}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0502}}
  >{\centering\arraybackslash}p{(\columnwidth - 18\tabcolsep) * \real{0.0103}}@{}}
\toprule
...
\midrule
\endhead
Title - Title is clear - Title is concise - Title informs the listener as to what the experiment is about & 1.5 pts Excellent All 3 criteria are met & & 1 pt Satisfactory 2 of the 3 criteria are met & & 0.5 pts Poor Only 1 of the criteria is met & & 0 pts Absent None of the criteria are met and/or no title was provided & & 1.5 pts \\
Introduction/Background Information - Relevant biological background provided - Student has clearly articulated how this background information is relevant - the information included is accurately reported - Student has clearly explained the significance of this information with respect to their experiment - There is no ambiguity within the information provided - Information provided is coherent, has a sensible flow, and is easy to follow & 6 pts Exceeds Expectations All 6 criteria met & & 5 pts Excellent 5 of the 6 criteria are met & 4 pts Proficient 4 of the 6 criteria are met & 3 pts Satisfactory 3 of the 6 criteria are met & 2 pts Poor 2 of the 6 criteria are met & 1 pt Unsatisfactory 1 of the 6 criteria are met & 0 pts Absent None of the criteria are met & 6 pts \\
Hypothesis - Is clearly stated in one sentence - Is supported by previous knowledge or research described within the background information - Is correctly stated based on the experimentation that was conducted & 3 pts Excellent All 3 criteria are met & & 2 pts Satisfactory 2 of the 3 criteria & & 1 pt Unsatisfactory 1 of the 3 criteria are met & & 0 pts Absent No criteria are met & 0 pts Absent No criteria are met & 3 pts \\
Experimental Design - Procedure outlined is clearly explained - No bullet points are used here - Experimental design properly addresses the hypothesis provided earlier - Clearly defines the type of data that was collected - Clearly identifies and describes the appropriate controls and variable(s) - Identifies which are the dependent and independent variable(s) - Statistical analysis used in this research is clearly explained & 7 pts Exceeds Expectations All 7 criteria are met & 6 pts Excellent 6 of the 7 criteria are met & 5 pts Satisfactory 5 of the 7 criteria are met & 4 pts Fair 4 of the 7 criteria are met & 3 pts Unsatisfactory 3 of the 7 criteria are met & 2 pts Below Expectations 2 of the 7 criteria are met & 1 pt Unacceptable 1 of the 7 criteria is met & 0 pts Absent None of the criteria are met & 7 pts \\
Figures - Appropriate figures are included - Key findings are clearly indicated within the figures - All axes are properly labeled and include units - Legend is provided - The explanation of the figure(s) is clear and includes a description of axes, legend, means, n value, p-value, and variance information when required - Figure is clear and easy to interpret on its own - Figure and/or table caption is clear and provides a clear description & 7 pts Exceeds Expectations All 7 criteria are met & 6 pts Excellent 6 of the 7 criteria are met & 5 pts Satisfactory 5 of the 7 criteria are met & 4 pts Fair 4 of the 7 criteria are met & 3 pts Unsatisfactory 3 of the 7 criteria are met & 2 pts Below Expectations 2 of the 7 criteria are met & 1 pt Unacceptable 1 of the 7 criteria is met & 0 pts Absent None of the criteria are met & 7 pts \\
Results - Easy to follow along - Clearly articulated and interpreted - Significance of these results on the field of student and/or academics in general are explained & 3 pts Excellent All 3 criteria are met & & 2 pts Fair 2 of the 3 criteria are met & & 1 pt Poor Only 1 of the criteria are met & & 0 pts Unacceptable None of the criteria are met & & 3 pts \\
References \& In-Text Citation - APA format is used appropriately and consistently - All in-text citations are provided when needed - References provided & 3 pts Satisfactory All 3 criteria are met & & 2 pts Fair 2 of the 3 criteria are met & & 1 pt Poor Only 1 of the criteria are met & & 0 pts Unacceptable None of the criteria are met & & 3 pts \\
Plagiarism - Quotations are not present - No form of any plagiarism present & 2 pts Satisfactory All criteria are met & & 1 pt Satisfactory Only 1 of the 2 criteria are met & & & 0 pts Absent The criterion is not met & & & 2 pts \\
Presentation - Students are organized and are equally participating in the presentation - Students show a clear understanding of the information they are presenting - All participants speak clearly and loud enough to be heard - Students engage the audience and display a clear passion/interest in their project & 4 pts Excellent All 4 criteria are met & & 3 pts Proficient 3 of the 4 criteria are met & & 2 pts Fair 2 of the 4 criteria are met & & 1 pt Unsatisfactory 1 of the 4 criteria are met & 0 pts Absent No criteria are met & 4 pts \\
Poster - Poster is approximately 24'' X 36'' in size - Is attractively presented - Language is simple and descriptive - Information is visible from 6 feet away - The main points of the poster are easy to determine within 30 seconds - Layout is clean and organized - Word count is between 300-800 - Acknowledgments are clearly identified & 5 pts Full Marks All 5 criteria are met & & 4 pts Proficient 4 of the 5 criteria are met & & 3 pts Satisfactory 3 of the 5 criteria are met & 2 pts Poor 2 of the 5 criteria are met & 1 pt Unsatisfactory Only 1 criteria is met & 0 pts No Marks No criteria are met & 5 pts \\
Total Points: 41.5 & & & & & & & & & \\
\bottomrule
\end{longtable}
