...
* **one categorical and one quantitative variable**, you will be provided with descriptive statistics for the quantitative variable, grouped according to the categories of the categorical variable.  Specifically: the sample size `n` (the number of observations belonging to each category), $p$ (the proportion of the observations belonging to each category), and the mean, standard deviation `sd`, and inter-quartile range `iqr` of the quantitative variable calculated for each category separately.
