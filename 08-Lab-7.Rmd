...
In this lab, we\'ll work with a few data sets that are preloaded into the Shiny App, so you can explore mapping different variables to a visual space.
...
The third dataset, called `titanic`, includes exclusively categorical variables describing attributes of passengers on the Titanic. 
